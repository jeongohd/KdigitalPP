            ...
            <div>
                <ul class='paging'>
                 	<c:if test="${data.prev == true }"> 
                 		<a href="javascript:getPage3(${data.startPage-1})"><i class="fa-solid fa-arrow-left"></i></a>
                 	</c:if>
                 	<c:forEach var="p" begin="${data.startPage }" end="${data.endPage }">
                    	<a href="javascript:getPage3(${p})">${p }</a>
                    </c:forEach>
                    <c:if test="${data.next == true }">
                 		<a href="javascript:getPage3(${data.endPage+1})" ><i class="fa-solid fa-arrow-right"></i></a>
                	</c:if>
               	</ul> 
            </div>
         </form>
